...
export const generateMetadata = async (): Promise<Metadata> => {
  return {
    ...
    description: "View all school assignments",
  };
};

const SchoolStaffAssignmentsPage = async (
  props: PageProps<"/[lang]/s-t/assignments">
) => {
    ...
    >
      <div className="space-y-6">
        <AppPageHeader
          total={totalCount}
          title="Assignments Overview"
          description="View all school assignments (Read-only)"
        />
        ...
        {assignments.length === 0 && (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Assignments will appear here once teachers create them
            </p>
          </div>
        )}
      </div>
...
export default SchoolStaffAssignmentsPage;
