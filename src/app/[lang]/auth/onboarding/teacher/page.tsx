import AuthOnboardingTeacherContent from "@/components/page/auth/auth-onboarding-teacher-content";
...
const TeacherOnboardingPage = async (props: Props) => {
