...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action ref={ref} className={cn("btn btn-sm btn-info max-sm:btn-md", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn("btn btn-sm btn-outline max-sm:btn-md", "mt-2 sm:mt-0", className)}
    {...props}
  />
));
